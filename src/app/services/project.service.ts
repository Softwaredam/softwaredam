  ...
  PROJECTS: Project[] = [
    {
      ...
      activities: [
        ...
        "DevOps",
        "Planning and exection of platform migration from Docker swarm to Kubernetes",
        "Presenting workshops and hands-on sessions"
      ],
      tools: [
        "Kubernetes", "Docker (swarm)", "Harbor", "Jenkins",
        "Java/JDK", "Java 8", "Java 11", "Java 14",
        "Spring", "Micronaut",
        "Maven",
        "GitLab", "PostgreSQL",
        "Nginx", "Apache", "Traefik", "Helm", "Ansible",
        "WSO2AM", "WSO2IS", "Postfix", "..."
      ],
    },
    {
      id: 57,
      ...
      tools: [
        "Microservice", "Kubernetes", "Docker", "GitLab", "Harbor", "WSO2AM",
        "PostgreSQL", "Java", "Java 8", "Java 11",
        "Spring", "Micronaut",
        "Gradle", "REST", "SOAP", "XML", "Json", "Security", "PKI PKIoverheid",
      ],
    },
...

    {
      ...
      activities: [
        "Implementation and testing of user stories", "Helping with design of the UI", "Taking part in all activiteis of the scrum team"
      ],
      tools: [
